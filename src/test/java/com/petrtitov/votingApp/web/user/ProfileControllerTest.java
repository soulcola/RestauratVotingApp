...
import static com.petrtitov.votingApp.testdata.UserTestData.*;
import static com.petrtitov.votingApp.web.user.ProfileController.REST_URL;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void register() throws Exception {
        UserTo newTo = new UserTo(null, "newName", "newemail@ya.com", "newPassword");
