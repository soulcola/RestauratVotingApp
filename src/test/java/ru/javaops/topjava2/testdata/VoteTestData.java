...
public class VoteTestData {
    ...
    public static Vote vote1 = new Vote(VOTE1_ID, USER_ID, RESTAURANT1_ID, LocalDate.of(2023, 1,1), LocalTime.of(10,0));
    public static Vote todayVote1 = new Vote(4, USER_ID, RESTAURANT1_ID, LocalDate.now(), LocalTime.now());


    public static Vote getNew() {
        return new Vote(USER_ID, RESTAURANT1_ID, LocalDate.now(), LocalTime.now());
    }
